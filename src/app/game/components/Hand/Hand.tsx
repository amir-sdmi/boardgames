...
export default function Hand({
  ...
  return (
    <div className="col-span-5 flex flex-col gap-2 rounded-2xl border-2 border-secondary px-6 pb-6 pt-5">
      <h2 className="text-lg font-bold text-secondary">Your Hand</h2>
